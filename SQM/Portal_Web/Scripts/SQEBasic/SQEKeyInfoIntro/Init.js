        ...
        success: function (data) {  
            ...
            if (data.length > 0) {
                ...
                if (CritialFile.IntroFGUID != "null" && CritialFile.IntroFGUID != "undefined") {
                    $("#sp" + "IntroFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.IntroFGUID)) + "'>" + CritialFile.IntroFN + "</a>");
                } else {
                ...
                if (CritialFile.EnvirFGUID != null && CritialFile.EnvirFGUID != "undefined") {
                    $("#sp" + "EnvirFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.EnvirFGUID)) + "'>" + CritialFile.EnvirFN + "</a>");
                } else {
                ...
                if (CritialFile.WaterResponseFGUID != null && CritialFile.WaterResponseFGUID != "undefined") {
                    $("#sp" + "WaterResponseFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.WaterResponseFGUID)) + "'>" + CritialFile.WaterResponseFN + "</a>");
                } else {
                ...
                if (CritialFile.ElecResponseFGUID != null && CritialFile.ElecResponseFGUID != "undefined") {
                    $("#sp" + "ElecResponseFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.ElecResponseFGUID)) + "'>" + CritialFile.ElecResponseFN + "</a>");
                } else {
                ...
                if (CritialFile.CMControlFGUID != null && CritialFile.CMControlFGUID != "undefined") {
                    $("#sp" + "CMControlFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.CMControlFGUID)) + "'>" + CritialFile.CMControlFN + "</a>");
                } else {
                ...
                if (CritialFile.NonCMQuestionaryFGUID != null && CritialFile.NonCMQuestionaryFGUID != "undefined") {
                    $("#sp" + "NonCMQuestionaryFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.NonCMQuestionaryFGUID)) + "'>" + CritialFile.NonCMQuestionaryFN + "</a>");
                } else {
                ...
                if (CritialFile.NonCMCommitFGUID != null && CritialFile.NonCMCommitFGUID != "undefined") {
                    $("#sp" + "NonCMCommitFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.NonCMCommitFGUID)) + "'>" + CritialFile.NonCMCommitFN + "</a>");
                } else {
                ...
                if (CritialFile.PollutionReportFGUID != null && CritialFile.PollutionReportFGUID != "undefined") {
                    $("#sp" + "PollutionReportFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.PollutionReportFGUID)) + "'>" + CritialFile.PollutionReportFN + "</a>");
                } else {
                ...
                if (CritialFile.PollutionAgreeFGUID != null && CritialFile.PollutionAgreeFGUID != "undefined") {
                    $("#sp" + "PollutionAgreeFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.PollutionAgreeFGUID)) + "'>" + CritialFile.PollutionAgreeFN + "</a>");
                } else {
                ...
                if (CritialFile.PollutionAcceptanceFGUID != null && CritialFile.PollutionAcceptanceFGUID != "undefined") {
                    $("#sp" + "PollutionAcceptanceFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.PollutionAcceptanceFGUID)) + "'>" + CritialFile.PollutionAcceptanceFN + "</a>");
                } else {
                ...
                if (CritialFile.WasteFGUID != null && CritialFile.WasteFGUID != "undefined") {
                    $("#sp" + "WasteFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.WasteFGUID)) + "'>" + CritialFile.WasteFN + "</a>");
                } else {
                ...
                if (CritialFile.ExhaustFGUID != null && CritialFile.ExhaustFGUID != "undefined") {
                    $("#sp" + "ExhaustFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.ExhaustFGUID)) + "'>" + CritialFile.ExhaustFN + "</a>");
                } else {
                ...
                if (CritialFile.WasteWaterFGUID != null && CritialFile.WasteWaterFGUID != "undefined") {
                    $("#sp" + "WasteWaterFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.WasteWaterFGUID)) + "'>" + CritialFile.WasteWaterFN + "</a>");
                } else {
                ...
                if (CritialFile.NoiseFGUID != null && CritialFile.NoiseFGUID != "undefined") {
                    $("#sp" + "NoiseFile").html("<a href='/VMIP2/SQMBasic/DownloadSQMFile?DataKey=" + escape($.trim(CritialFile.NoiseFGUID)) + "'>" + CritialFile.NoiseFN + "</a>");
                } else {
