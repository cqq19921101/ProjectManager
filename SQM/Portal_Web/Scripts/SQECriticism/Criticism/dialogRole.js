        ...
        buttons: {
            OK: function () {
                if (Mapdialog.attr('Mode') == "v") {
                    ...
                    $.ajax({
                        url: __WebAppPathPrefix + ((Mapdialog.attr('Mode') == "c") ? "/SQECriticism/CreateCriticismMap" : "/SQECriticism/EditCriticismMap"),
                        data: {
                            "MemberGUID":$("#SQEContactdialogData").attr('MemberGUID'),
        ...
        buttons: {
            OK: function () {
                if (dialog.attr('Mode') == "v") {
                    ...
                    var DoSuccessfully = false;
                    $.ajax({
                        url: __WebAppPathPrefix + ((dialog.attr('Mode') == "c") ? "/SQECriticism/CreateCriticism" : "/SQECriticism/EditCriticism"),
                        data: {
                            ...
                            "ScoringRatio": escape($.trim($("#txtScoringRatio").val())),
...
function InfoDialogSetUIByMode() {
    ...
    var dataRow = gridDataList.jqGrid('getRowData', RowId);
    $.ajax({
        url: __WebAppPathPrefix + '/SQECriticism/LoadCriticismInfoJSonWithFilter',// url: __WebAppPathPrefix + '/VMIBulletin/GetBulletinCategoryList',
