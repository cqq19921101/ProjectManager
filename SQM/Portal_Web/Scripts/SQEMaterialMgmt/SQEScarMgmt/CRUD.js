$(function () {
                ...
                success: function (data) {
                    ...
                    if (data[0].appovestatus1=='1'||data[0].appovestatus1==undefined) {
                        ...
                        $('#D2 *').attr("disabled", "disabled");
                          $('#btnAppove1').show();
                          $('#btnReject1').show();
                          $('#btnAppove1').removeAttr('disabled');
                    ...
                    if (data[0].appovestatus2 == '1' || data[0].appovestatus2 == undefined) {
                        $('#D6 *').attr("disabled", "disabled");
                         $('#btnAppove2').show();
                         $('#btnReject2').show();
                         $('#btnAppove2').removeAttr('disabled');
                         $('#btnReject2').removeAttr('disabled');
                    ...
                    if (data[0].appovestatus1 == '0' && data[0].appovestatus2=='0') {
                        $('btnD2Save').show();
                    }
    ...
    jQuery("#btnD2Save").click(function () {
        ...
        $.ajax({
            url: __WebAppPathPrefix + "/SQMMaterialMgmt/UpdateD8",
            data: {
                "SID": SCARSID,
                "rejectOrder": escape($.trim($('#txtrejectOrder1').val())) + ";" + escape($.trim($('#txtrejectOrder2').val())) + ";" + escape($.trim($('#txtrejectOrder3').val())),
    ...
    jQuery("#btnD9Save").click(function () {
        ...
        $.ajax({
            ...
            data: {
                ...
                "VenderCode": escape($.trim($("#txtVenderCode").val())),
            ...
            success: function (data) {
                if (data == "") {
                    DoSuccessfully = true;
                    alert("Create successfully.SQE发送成功");
                    $('#D1').show();
