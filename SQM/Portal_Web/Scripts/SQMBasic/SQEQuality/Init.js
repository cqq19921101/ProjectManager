$(function () {
    ...
    var cn = ['ReportSID',
              '報告單號',
                ...
                '報告類型',
              '供應商',
    '出貨日', '送貨數量', '製造商料號', '料號', '生產批號', '生產日期', '檢驗日', '生產地', '批次', '是否變更製程', '變更說明', '設備', '原料', '品管員',  '檢驗結果', '附件'];
    var cm = [
    ...
    gridDataList.jqGrid({
        url: __WebAppPathPrefix + '/SQMBasic/LoadQualityJSonWithFilter',
        postData: { SearchText: "" },
        type: "post",
        datatype: "json",
        jsonReader: {
        ...
        onCellSelect: function (rowid, iCol, cellcontent, e) {
            ...
            if (iCol == 19) {
                ...
                gridDataListInspVar.jqGrid('setGridParam', { postData: { ReportSID: $this.jqGrid('getCell', rowid, 'ReportSID') } });
