$(function () {
    $.ajax({
        url: __WebAppPathPrefix + '/SQMBasic/GetCriticismType',// url: __WebAppPathPrefix + '/VMIBulletin/GetBulletinCategoryList',
    ...
    gridDataList.jqGrid({
        url: __WebAppPathPrefix + '/SQMBasic/LoadCriticismMapJSonWithFilter',
        postData: { SearchText: "" },
        type: "post",
        datatype: "json",
        jsonReader: {
    ...
    InfogridDataList.jqGrid({
        url: __WebAppPathPrefix + '/SQMBasic/LoadCriticismJSonWithFilter',
