        ...
        buttons: {
            OK: function () {
                if (dialogP.attr('Mode') == "v") {
                    ...
                    $.ajax({
                        url: __WebAppPathPrefix + ((dialogP.attr('Mode') == "c") ? "/SQMBasic/CreatePro" : "/SQMBasic/EditPro"),
                        data: {
                            ...
                            , "AnnualCapacitySpan": escape($.trim($("#txtAnnualCapacitySpan").val()))
                        },
                        type: "post",
                        dataType: 'text',
                        async: false,
...
function DialogSetUIByModeP(Mode) {
    ...
    switch (Mode) {
        case "c": //Create
            ...
            $("#txtAnnualCapacitySpan").val("");
            $("#txtAnnualCapacitySpan").removeAttr('disabled');
        ...
        case "v": //View
            ...
            $("#txtAnnualCapacitySpan").val(dataRowP.AnnualCapacitySpan);
            $("#txtAnnualCapacitySpan").attr("disabled", "disabled");
