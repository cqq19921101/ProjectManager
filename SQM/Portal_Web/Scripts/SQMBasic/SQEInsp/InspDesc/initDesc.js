$(function () {
    ...
    gridDataListDesc.jqGrid({
        ...
        colModel: [
            ...
            { name: 'Insptype', index: 'Insptype', width: 150, sortable: true, sorttype: 'text', hidden: true }
        ],
        rowNum: 10,
        //rowList: [10, 20, 30],
        sortname: 'InspCode',
    ...
    gridDataListDesc.jqGrid('navGrid', '#gridListPagerDesc', { edit: false, add: false, del: false, search: false, refresh: false });
