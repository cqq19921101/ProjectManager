    ...
    jQuery("#btnDelete").click(function () {
        ...
        {   //single select
            ...
            if (RowId) {
                ...
                //if (r == "ok") {
                if (confirm("Confirm to delete selected member (" + gridDataList.jqGrid('getRowData', RowId).LitNo + ")?\n\n(Note. Data cannot be recovered once deleted)")) {
                        $.ajax({
                            url: __WebAppPathPrefix + "/SQMBasic/DeleteLitNO_Plant",
