...
function getPollutionTypes() {
    $.ajax({
        ...
        success: function (data) {
            var options = '';
            for (var idx in data) {
                options += '<input id="cbPollutionType' + data[idx].PARAME_ITEM + '" cbtype="PollutionType" type="checkbox" name="vehicle" value="' + data[idx].PARAME_ITEM + '" >' + data[idx].PARAME_VALUE1 + '<BR/>'
            }
...
function getWasteTypes() {
    $.ajax({
        ...
        success: function (data) {
            var options = '';
            for (var idx in data) {
                options += '<input id="cbWasteTypes' + data[idx].PARAME_ITEM + '" cbtype="WasteTypes" type="checkbox" value="' + data[idx].PARAME_ITEM + '" >' + data[idx].PARAME_VALUE1 + '<BR/>'
            }
...
function getCommonTypes() {
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#ddl" + "ExhaustType").append(options);
            $("#ddl" + "WasteWaterType").append(options);
            $("#ddl" + "NoiseType").append(options);
...
function getPeriodType() {
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#ddl" + "PollutionEventType").append(options);
            $("#ddl" + "PunishmentType").append(options);
