$(function () {
    var diaCorpMemberGUID = $('#dialog_VMI_QueryCorpMemberGUID2');
    var diaVMIMGgridDataList = $('#dialog_VMI_CorpMemberGUID_gridDataList2');

    //Init Function dialog Button
    //Button
    $('#dialog_btn_diaCorpMemberGUID_Search2').button({
        label: "Query",
        icons: { primary: 'ui-icon-search' }
    });

    //After Init. to Show Menu Function Button
    $('#dialog_Corp_VDN_MGTopToolBar2').show();
    ...
    diaVMIMGgridDataList.jqGrid({
        ...
        onSelectRow: function (id) {
            ...
            if (selRow) {
                ...
                $(__SelectorSource).val(rowData.NameInChinese);
        ...
        viewrecords: true,
        loadonce: true,
        pager: '#dialog_VMI_CorpMemberGUID_gridDataPager2',
    ...
    diaVMIMGgridDataList.jqGrid('navGrid', '#dialog_VMI_CorpMemberGUID_gridDataPager2', { edit: false, add: false, del: false, search: false, refresh: false });
});