$(function () {
    var diaCorpMemberGUID = $('#dialog_VMI_QueryCorpMemberGUID1');
    var diaVMIMGgridDataList = $('#dialog_VMI_CorpMemberGUID_gridDataList1');

    //Init Function dialog Button
    //Button
    $('#dialog_btn_diaCorpMemberGUID_Search1').button({
        label: "Query",
        icons: { primary: 'ui-icon-search' }
    });

    //After Init. to Show Menu Function Button
    $('#dialog_Corp_VDN_MGTopToolBar1').show();
    ...
    diaVMIMGgridDataList.jqGrid({
        ...
        onSelectRow: function (id) {
            ...
            if (selRow) {
                ...
                $(__SelectorMember).val(rowData.NameInChinese);
