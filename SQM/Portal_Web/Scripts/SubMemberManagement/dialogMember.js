        ...
        buttons: {
            OK: function () {
                if (dialog.attr('Mode') == "v") {
                    ...
                    $.ajax({
                        url: __WebAppPathPrefix + ((dialog.attr('Mode') == "c") ? "/SubSystemMgmt/CreateMember" : "/SubSystemMgmt/EditMember"),
                        data: {
...
$(function () {
    $("#btnDiaReadInternalUserInfo").click(function () {
        ...
        $.ajax({
            url: __WebAppPathPrefix + "/SubSystemMgmt/GetInternalUserInfoByAccountID",
