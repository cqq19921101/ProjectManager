        ...
        buttons: {
            OK: function () {
                if (Mapdialog.attr('Mode') == "v" || Mapdialog.attr('Mode') == "u") {
                    ...
                    $.ajax({
                        url: __WebAppPathPrefix + ((Mapdialog.attr('Mode') == "c") ? "/SQEReliability/CreateReliability" : "/SQEReliability/UpdateReliInfo"),
                        data: {
        ...
        buttons: {
            OK: function () {
                if (dialog.attr('Mode') == "v") {
                    ...
                    var DoSuccessfully = false;
                    $.ajax({
                        url: __WebAppPathPrefix + ((dialog.attr('Mode') == "c") ? "/SQEReliability/CreateReliInfo" : "/SQEReliability/UpdateReliInfo"),
                        data: {
