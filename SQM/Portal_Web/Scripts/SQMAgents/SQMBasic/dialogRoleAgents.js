        ...
        buttons: {
            OK: function () {
                if (dialogA.attr('Mode') == "v") {
                    ...
                    $.ajax({
                        url: __WebAppPathPrefix + ((dialogA.attr('Mode') == "c") ? "/SQMAgents/CreateAgents" : "/SQMAgents/EditAgents"),
                        data: {
        ...
        buttons: {
            OK: function () {
                if (dialogA.attr('Mode') == "v") {
                    ...
                    var DoSuccessfully = false;
                    $.ajax({
                        url: __WebAppPathPrefix + ((dialogA.attr('Mode') == "c") ? "/SQMAgents/CreateAgents2" : "/SQMAgents/EditAgents2"),
                        data: {
                            "BasicInfoGUID": dialogA.attr("BasicInfoGUID"),
