$(function () {
    ...
    jQuery("#btnSave3").click(function () {
        $(this).removeClass('ui-state-focus');
        var DoSuccessfully = false;
        $.ajax({
            url: __WebAppPathPrefix + "/Hold/UpdateHold",
            data: {
        ...
        $(this).removeClass('ui-state-focus');
            ...
            if (RowId) {
                ...
                $.ajax({
                    ...
                    data: { "HoldNo": gridDataList.jqGrid('getRowData', RowId).HoldNo, "ReleaseQuantity": escape($.trim($('#txtReleaseQuantity').val())) },
                    type: "post",
                    dataType: 'text',
                    async: false,
                    success: function (data) {
        ...
        $(this).removeClass('ui-state-focus');
            ...
            if (RowId) {
                ...
                $.ajax({
                    ...
                    data: { "HoldNo": gridDataList.jqGrid('getRowData', RowId).HoldNo, "RejectQuantity": escape($.trim($('#txtRejectQuantity').val())) },
                    type: "post",
                    dataType: 'text',
                    async: false,
                    success: function (data) {
