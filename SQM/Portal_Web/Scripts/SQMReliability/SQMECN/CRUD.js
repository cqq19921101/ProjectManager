$(function () {
    ...
    $("#txtProposedDate").datepicker("setDate", '-31d');
    ...
    $("#txtRequestDate").datepicker("setDate", '-31d');
    ...
    jQuery("#btnDelete").click(function () {
        ...
        {   //single select
            ...
            if (RowId) {
                ...
                //if (r == "ok") {
                if (confirm("Confirm to delete selected member (" + gridDataList.jqGrid('getRowData', RowId).TZDNo + ")?\n\n(Note. Data cannot be recovered once deleted)")) {
                        $.ajax({
                            url: __WebAppPathPrefix + "/SQMReliability/DeleteECN",
                            ...
                            success: function (data) {
                                if (data == "") {
                                    $("#btnSearch").click();
                                    alert("ECN delete successfully.");
                                }
                                else {
                                    alert("ECN delete fail due to:\n\n" + data);
                                }
                            },
