$(function () {
    ...
    $('#btnDownloadExcel').click(function () {
        ...
        if (fromPostDate == '' || toPostDate == '') {
            ...
            $.ajax({
                url: __WebAppPathPrefix + '/VMIQuery/GetPOAPCheckExcelFileList',
                data: {
                ...
                success: function (data) {
                    if (data.length == 0) {
                        ...
                        $(data).each(function (idx, item) {
                            filesLink += '<a id="' + item.vendor + '_' + item.plant + '" class="downloadExcel" href="#">' + item.vendor + '_' + item.plant + '_NormalPO-GRDetail.xlsx' + '</a><br />';
                        });
                        ...
                        $('.downloadExcel')
                            ...
                            .click(function () {
                                ...
                                $.ajax({
                                    url: __WebAppPathPrefix + '/VMIQuery/POAPCheckExportExcel',
                                    data: {
                                        fromVendorCode: escape(fromVendorCode),
                                        toVendorCode: escape(toVendorCode),
                                        fromCompanyCode: escape(fromCompanyCode),
                        ...
                        $('#dialogPOAPCheckStatementResult').dialog('open');
                    }
                },
                error: function (xhr, textStatus, thrownError) {
                    $.CommonUIUtility_AjaxErrorHandler(xhr, textStatus, thrownError, __UrlForTimeOut);
    ...
    $('#btnDownloadPDF').click(function () {
        ...
        if (fromPostDate == '' || toPostDate == '') {
            ...
            $.ajax({
                url: __WebAppPathPrefix + '/VMIQuery/GetPOAPCheckPDFFileList',
                data: {
                    fromVendorCode: escape(fromVendorCode),
                    toVendorCode: escape(toVendorCode),
                    fromCompanyCode: escape(fromCompanyCode),
                ...
                success: function (data) {
                    if (data.length == 0) {
                        ...
                        var filesLink = '';
                        if (downloadType == 'O') {
                            filesLink = '<a id="OneFile" class="downloadPDF" href="#">NormalPO-GRPDF.pdf</a><br />';
                        }
                        else {
                            $(data).each(function (idx, value) {
                                filesLink += '<a id="' + value + '" class="downloadPDF" href="#">' + value + '_NormalPO-GRPDF.pdf' + '</a><br />';
                            });
                        }
                        $('#tdFiles').html(filesLink);
                        ...
                        $('.downloadPDF')
                            ...
                            .click(function () {
                                ...
                                $.ajax({
                                    url: __WebAppPathPrefix + '/VMIQuery/POAPCheckExportPDF',
                                    data: {
                                        fromVendorCode: escape(fromVendorCode),
                                        toVendorCode: escape(toVendorCode),
                                        fromCompanyCode: escape(fromCompanyCode),
