...
namespace Lib_SQM_Domain.Modal
{
    ...
    public class MenuItemBase2
    {
        protected string _FunctionGUID = "";
        protected int _MenuLevel = 1;
        protected string _IntranetHref = "";
        protected string _InternetHref = "";
        protected HrefTarget _HrefTarget = HrefTarget.self;
        protected int _SortCode = 0;
        protected string _ParentFunctionGUID = "";
        protected string _Title_en_US = "";
        protected string _Title_zh_CN = "";
        protected string _Title_zh_TW = "";

        protected string _level = "0";
        protected string _parent = "";
        protected bool _isLeaf = true;
        ...
        public int MenuLevel { get { return this._MenuLevel; } set { this._MenuLevel = value; } }
        public string IntranetHref { get { return this._IntranetHref; } set { this._IntranetHref = value; } }
        public string InternetHref { get { return this._InternetHref; } set { this._InternetHref = value; } }
        public HrefTarget HrefTarget { get { return this._HrefTarget; } set { this._HrefTarget = value; } }
        public int SortCode { get { return this._SortCode; } set { this._SortCode = value; } }
        public string ParentFunctionGUID { get { return this._ParentFunctionGUID; } set { this._ParentFunctionGUID = value; } }
        public string Title_en_US { get { return this._Title_en_US; } set { this._Title_en_US = value; } }
        public string Title_zh_CN { get { return this._Title_zh_CN; } set { this._Title_zh_CN = value; } }
        public string Title_zh_TW { get { return this._Title_zh_TW; } set { this._Title_zh_TW = value; } }

        public string level { get { return this._level; } set { this._level = value; } }
        public string parent { get { return this._parent; } set { this._parent = value; } }
        public bool isLeaf { get { return this._isLeaf; } set { this._isLeaf = value; } }
        public bool expanded { get { return this._expanded; } set { this._expanded = value; } }
        public bool loaded { get { return this._loaded; } set { this._loaded = value; } }

        public MenuItemBase2() { }
        public MenuItemBase2(string FunctionGUID, int MenuLevel, string IntranetHref, string InternetHref, HrefTarget HrefTarget, int SortCode, string ParentFunctionGUID)
        {
            this._FunctionGUID = FunctionGUID;
            this._MenuLevel = MenuLevel;
            this._IntranetHref = IntranetHref;
            this._InternetHref = InternetHref;
            this._HrefTarget = HrefTarget;
            this._SortCode = SortCode;
            this._ParentFunctionGUID = ParentFunctionGUID;
        }
    }

    public class MenuItem2 : MenuItemBase2
    {
        private List<string> _Roles = new List<string>();
        public List<string> Roles { get { return this._Roles; } set { this._Roles = value; } }
        private List<string> _ControllerActions = new List<string>();
        public List<string> ControllerActions { get { return this._ControllerActions; } set { this._ControllerActions = value; } }

        public MenuItem2() : base() { }
        public MenuItem2(string FunctionGUID, int MenuLevel, string IntranetHref, string InternetHref, HrefTarget HrefTarget, int SortCode, string ParentFunctionGUID)
            : base(FunctionGUID, MenuLevel, IntranetHref, InternetHref, HrefTarget, SortCode, ParentFunctionGUID) { }
    }

    public class MenuItemFromView2 : MenuItemBase2
    {
        private string _RolesString = "";
        private List<string> _Roles = new List<string>();
        public string RolesString
        {
            get { return this._RolesString; }
            set
            {
                if (value.Trim() == "")
                {
                    this._RolesString = "";
                    if (this._Roles.Count > 0) this._Roles.Clear();
                }
                else
                {
                    string[] rarray = value.Trim().Split(',');
                    for (int iCnt = 0; iCnt < rarray.Length; iCnt++)
                        this._Roles.Add(rarray[iCnt]);
                }
            }
        }
        public List<string> Roles { get { return this._Roles; } }

        private string _ControllerActionString = "";
        private List<ControllerAction> _ControllerActions = new List<ControllerAction>();
        public string ControllerActionString
        {
            get { return this._ControllerActionString; }
            set
            {
                if (value.Trim() == "")
                {
                    this._ControllerActionString = "";
                    if (this._ControllerActions.Count > 0) this._Roles.Clear();
                }
                else
                {
                    string[] rarray = value.Trim().Split(',');
                    for (int iCnt = 0; iCnt < rarray.Length; iCnt++)
                    {
                        string[] fca = rarray[iCnt].Split('|');
                        this._ControllerActions.Add(new ControllerAction(fca[0], fca[1]));
                    }
                }
            }
        }
        public List<ControllerAction> ControllerActions { get { return this._ControllerActions; } }

        public MenuItemFromView2() : base() { }
        public MenuItemFromView2(string FunctionGUID, int MenuLevel, string IntranetHref, string InternetHref, HrefTarget HrefTarget, int SortCode, string ParentFunctionGUID)
            : base(FunctionGUID, MenuLevel, IntranetHref, InternetHref, HrefTarget, SortCode, ParentFunctionGUID) { }
    }

    public enum HrefTarget { blank, self }
    ...
    public class FunctionTitle
    {
        ...
        public FunctionTitle(string FunctionGUID, string Locale, string Title)
        {
            this._FunctionGUID = FunctionGUID;
            this._Locale = Locale;
            this._Title = Title;
    ...
    public class FunctionRole
    {
        ...
        public FunctionRole(string FunctionGUID, string RoleGUID)
        {
            this._FunctionGUID = FunctionGUID;
    ...
    public class FunctionControllerAction : ControllerAction
    {
        private string _FunctionGUID = "";

        public string FunctionGUID { get { return this._FunctionGUID; } set { this._FunctionGUID = value; } }

        public FunctionControllerAction(string FunctionGUID, string Controller, string Action)
    ...
    public class SystemMgmt_Menu_jQGridJSon
    {
        public List<MenuItem2> Rows = new List<MenuItem2>();
        public string Total
        {
    ...
    public static class SystemMgmt_Menu_Helper
    {
        #region Get Menu
            ...
            foreach (MenuItemFromView2 m in NewMenu)
            {
                ...
                try
                {
                    using (SqlCommand cmd = new SqlCommand(sSQL, cnPortal, tran))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@IntranetHref", SQMStringHelper.NullOrEmptyStringIsDBNull(m.IntranetHref));
                        cmd.Parameters.AddWithValue("@InternetHref", SQMStringHelper.NullOrEmptyStringIsDBNull(m.InternetHref));
                        if (m.IntranetHref == "")
                        ...
                        cmd.Parameters.AddWithValue("@ParentFunctionGUID", SQMStringHelper.NullOrEmptyStringIsDBNull(m.ParentFunctionGUID));
                        cmd.ExecuteNonQuery();
                    }
                }
